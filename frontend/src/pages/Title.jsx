	...
	return (
		<div>
			  ...
			  <div className="flex flex-col items-center justify-center">
				<Button className='btn h-12 w-1/3 border-solid border-2 border-black rounded-lg mt-14 bg-emerald-400 hover:bg-emerald-500'>Get Started</Button>
				<Button className='btn h-12 w-1/3 border-solid border-2 border-black rounded-lg mt-8 bg-slate-100 hover:bg-slate-200'>I already have an account</Button>
        	</div>
