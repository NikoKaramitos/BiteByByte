    ...
    return (
		<div className="relative w-full h-screen bg-zinc-900/90">
				...
				<div className=" flex justify-center items-center h-full">
					<form className="max-w-[400px] w-full rounded 2xl shadowl border-4 border-black 2xl mx-auto bg-teal-400 p-8">
						...
						<div className="flex flex-col mb-4 text-sm">
							...
							invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-500" type="password" placeholder=" " required ref={(c) => (loginPassword = c)} />
						</div>
						<a href="#_" className="relative flex flex-col items-center py-2 mt-3 mb-3 overflow-hidden font-medium text-black border-2 border-orange-500 rounded-full hover:text-white group hover:bg-gray-50">
						...
						<button id="registerButton" className="w-full py-3 mt-4 bg-orange-500 hover: relative text-white" onClick={() => navigate('/register')}>Register</button>
					</form>
				</div>
				<Footer/>
			</div>
